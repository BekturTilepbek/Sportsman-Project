...
const Footer = () => {
  return (
    <footer className="md:mt-[120px] py-[70px] shadow-[0_-4px_6px_-1px_#0000001a] ">
      <nav className="bg-white py-[40px] md:py-0 px-[20px] md:px-0  md:mb-[84px] ">
        <div className="w-full flex items-center justify-between container snap-y">
          <div>
                <Image
                  src="/logo.svg"
