        ...
        <div className="min-h-[300px] relative flex gap-[50px] justify-between">
          <div className=" absolute right-0 top-0 flex justify-end">
            <button
              ...
              className="w-full px-5  h-[36px] rounded-[5px] flex justify-center items-center gap-[10px]  shadow-[0_0_4px_0_#00000029] "
            >
              <svg
                width="18"
                height="18"
          ...
          <div className="  min-w-[340px] p-[20px] sticky top-[350px] h-fit hidden md:flex flex-col gap-[20px] items-center shadow-[0_0_.625rem_0_#00000014]">
