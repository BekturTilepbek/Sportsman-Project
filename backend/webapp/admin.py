...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('image_tag', 'name', 'price', 'category', 'is_original', 'is_active')
    list_filter = ('category', 'brand', 'is_active', 'is_original')
    search_fields = ('name', 'description')
    prepopulated_fields = {'slug': ('name',)} # Автоматически создает slug из названия
